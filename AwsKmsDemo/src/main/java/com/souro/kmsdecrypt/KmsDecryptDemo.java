...
public class KmsDecryptDemo {
	...
	public static void main(String[] args) {
		...
		AWSKMSClient kmsClient = new AWSKMSClient(new ClasspathPropertiesFileCredentialsProvider(), configuration);
